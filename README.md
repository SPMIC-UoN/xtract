...
For the baby xtract protocols, please cite:
...
```
 ...
 Usage:
     ...
     Compulsory arguments:
        ...
        -species <SPECIES>                     One of HUMAN or MACAQUE or BABY or CUSTOM
     ...
     Optional arguments:
        ...
        -stdwarp <std2diff> <diff2std>         Standard2diff and Diff2standard transforms (Default=bedpostx_dir/xfms/{standard2diff_warp,diff2standard_warp})
        -stdref <reference>                    Standard space reference image (Default = $FSLDIR/data/standard/MNI152_T1_1mm [HUMAN], $datadir/standard/F99/mri/struct_brain [MACAQUE], $datadir/standard/neonate/schuh_template [BABY])
        -gpu                                   Use GPU version
...
-	warps			      - a reference standard space image and warps to and from the native diffusion and standard spaces, e.g. `MNI152.nii.gz standard2diff_warp.nii.gz diff2standard_warp.nii.gz`
